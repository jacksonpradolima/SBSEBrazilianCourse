---
titulo: "Aulas 15-16: Período de Desenvolvimento e Entrega do Projeto Final - Aplicando SBSE+IA de Forma Autônoma"
aula_numero: "15-16"
carga_horaria: "8 horas"
foco_principal: "Período dedicado ao desenvolvimento autônomo do Projeto Final, onde os alunos consolidam e aplicam todo o conhecimento adquirido em SBSE e IA para resolver um problema real."
metodologia: "Desenvolvimento Autônomo e Suporte Assíncrono"
tipo_aula: "Projeto Prático"
objetivos:
  - "Consolidar e aplicar de forma autônoma todo o conhecimento adquirido em SBSE e técnicas de IA em um projeto integrado."
  - "Desenvolver um sistema completo que demonstre maestria técnica na formulação, implementação e validação de soluções SBSE+IA."
  - "Comunicar efetivamente os resultados através de documentação técnica de qualidade profissional e apresentação em vídeo."
pre_requisitos:
  - "Domínio completo dos conceitos e técnicas de SBSE (Módulos 1-5)."
  - "Experiência prática com DEAP, Pymoo, APIs de LLMs e ferramentas de desenvolvimento."
  - "Plano de projeto definido e aprovado (Aula 12)."
---
...
graph TD
    ...
    A --> D[Integração Inovadora];
    A --> E[Validação Rigorosa];
    
    B --> B1[Problema relevante e bem definido];
    B --> B2[Representação inteligente];
    B --> B3[Fitness robusta com restrições];
    
    C --> C1[Código limpo e documentado];
    C --> C2[Uso correto de bibliotecas];
    C --> C3[Eficiência computacional];
    
    D --> D1[IA realmente melhora a solução];
    D --> D2[Integração não é cosmética];
    D --> D3[Demonstração clara do valor];
    
    E --> E1[Comparações com baselines];
    E --> E2[Análise estatística adequada];
    E --> E3[Insights e interpretações];
```
