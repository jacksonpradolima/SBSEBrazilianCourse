...
Recomenda-se o uso de ferramentas como o **NotebookLM** para auxiliar na pesquisa, na criação do roteiro do vídeo e na documentação do projeto, demonstrando a aplicação de IA no próprio processo de desenvolvimento.

## Avaliação e Feedback
A nota será atribuída com base nos critérios detalhados no documento de especificação do projeto. O feedback detalhado será enviado individualmente pelo professor após o período de correção.